...
- Using a low-level library that abstracts for you things like dom manipulation, scales, etc, [d3.js](https://d3js.org/) is a very good one: I wrote a :astro-ref[blog post about it]{path="blog/2021/understanding-d3-js-introduction"}
