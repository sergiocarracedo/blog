...
[SAO](https://saojs.org/) describes itself as a _Futuristic scaffolding tool_. and it's inspired in [Yeoman](https://yeoman.io/)

These tools allow you to ask the user who runs your _create-app_ questions that you could use to make decisions to install or configure different elements.
