...
The first thing I thought is that the problem was the animations. I remove them: _Nothing changes_.

I remove javascript: _Nothing_ :confused:

I continue removing things and trying other things to understand the problem. _No results_ :open_mouth:
