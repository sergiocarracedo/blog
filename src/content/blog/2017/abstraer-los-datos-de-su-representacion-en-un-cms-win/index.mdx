...
Aún más, si la fecha además de estar guardada en un campo separado, está guardada de forma estructurada (por ejemplo un _timestamp + timezone_) podremos mostrar la fecha y hora en las distintas zonas horarias y en los distintos formatos de fecha: *DD/MM/YYY, MM/DD/YYY, etc*
