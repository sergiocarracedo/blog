...
Hace unos días descubrí en twitter a través de un *retweet* a un usuario que merece la pena seguir [@patxangas](http://twitter.com/patxangas) y en uno de sus tweets nos descubira la herramienta [www.regexper.com](http://www.regexper.com) que a partir de una expresión regular genera un grafo como el que veis en la imagen que acompaña a esta entrada. El ejemplo empleado es
