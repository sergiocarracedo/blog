...
pubDate: 2019-12-03
slug: 2019/12/03/programacion-funcional-en-php/
...
Esto nos da ventajas como poder cachear sin miedo el valor del resultado para un conjunto de parámetros de entrada ya que el resultado _siempre_ será el mismo.
...
Otra de las piezas importantes de la _programación funcional_ en PHP (y otros lenguajes) las _closures_. Las _closures_ permiten a una función acceder a las variables del ámbito donde es ejecutada.
...
Como veis las posibilidades son muchas sobre todo para trabajar con _Colecciones_ (_arrays_, _objectos_ o _generadores_).
