...
Poco puedo añadir a la historia de como se forjó el evento a lo descrito en este _estupendo_ post de Rolando Caldas, que os recomiendo encarecidamente leer ⬇️⬇️⬇️⬇️⬇️
...
Por añadir algo, me gustaría contar un poco de mi experiencia a nivel personal de lo que ha significado la _PulpoCon19_.
...
:astro-ref[recuperándome de un linfoma]{path="blog/2018/Cosas-que-he-aprendido-de-un-cancer"}
...
Y así fue: lo poco que pudo estar en mi mano lo fui más o menos haciendo, todo ello siendo consciente, y es **algo que quiero decir alto y claro**, de que la _PulpoCon19_ no sería posible sin el trabajo de [Félix Gómez](https://twitter.com/felixgomezlopez) y [Rolando Caldas](https://twitter.com/rolando_caldas?lang=es), también co-organizadores de PHPVigo.
...
Pero guardo como una lección el ejemplo que han sido para mí los ponentes, _personas que han dedicado un fin de semana de sus vidas a compartir sus conocimientos de forma desinteresada con todos nosotros_
