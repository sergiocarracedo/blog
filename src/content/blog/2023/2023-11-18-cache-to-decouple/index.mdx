...
There are :astro-ref[different strategies you can follow to implement the cache]{path="/blog/2023/2023-05-07-frontend-cache-strategies"}) in the infra layer: HTTP cache (Proxy or Browser internal cache), but in these cases for better flexibility invalidating the caches in the frontend it's better our application (infra layer again) manage the cache.
