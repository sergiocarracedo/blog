...
> This post is part of a post series: :astro-ref[First part]{path="/blog/2024/2024-10-19-table-component"}, :astro-ref[Second part]{path="/blog/2024/2024-10-21-table-component-ii"}, :astro-ref[Third part]{path="/blog/2024/2024-10-27-table-component-iii"} and an extra related post: :astro-ref[Writing a query builder to filter data]{path="/blog/2024/2024-10-24-query-builder"}
