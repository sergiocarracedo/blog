...
I wrote posts (:astro-ref[1]{path="/blog/2024/2024-10-19-table-component"}), :astro-ref[2]{path="/blog/2024/2024-10-21-table-component-ii"}), :astro-ref[3]{path="/blog/2024/2024-10-27-table-component-iii"}) and , :astro-ref[4]{path="/blog/2024/2024-11-26-table-component-iv"})) about my learnings creating table components, and this post can be the third part as I made a query builder for that component, but it can be used in other uses cases.
