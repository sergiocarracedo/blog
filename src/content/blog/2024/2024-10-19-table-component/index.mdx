...
> This post is part of a post series: :astro-ref[Second part]{path="/blog/2024/2024-10-21-table-component-ii"}, :astro-ref[Third part]{path="/blog/2024/2024-10-27-table-component-iii"}, :astro-ref[Fourth part]{path="/blog/2024/2024-11-26-table-component-iv"}, and an extra related post: :astro-ref[Writing a query builder to filter data]{path="/blog/2024/2024-10-24-query-builder"}
...
> A table is a set of _normalized_ data (the **rows**) organized in columns (**cols**). The rows contain **cells**, that represent the cross between a row element and a column.
...
:astro-ref[Lessons I learned creating a table component (part II)]{path="/blog/2024/2024-10-21-table-component-ii"}