...
>
> :astro-ref[Chapter I: Introduction]{path="/blog/2024/2023-12-02-ui-components-library"}
...
At this point, we can define the component's interfaces or the surfaces of the _black box_. I usually like to divide those interfaces into two categories, depending on the developer's point of view:

### External interface

It's the interface the developer can use to interact with the _black box_ (component) and to get the results. The interface could not be the same for all the frameworks, but the concepts are similar.
