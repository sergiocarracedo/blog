...
> This post is part of a post series: :astro-ref[First part]{path="/blog/2024/2024-10-19-table-component"}), :astro-ref[Third part]{path="/blog/2024/2024-10-27-table-component-iii"}), :astro-ref[Fourth part]{path="/blog/2024/2024-11-26-table-component-iv"}), and an extra related post: :astro-ref[Writing a query builder to filter data]{path="/blog/2024/2024-10-24-query-builder"}

In the :astro-ref[first chapter]{path="/blog/2024/2024-10-19-table-component"} I talked about the data and cols definition. How to manipulate the data, transform it, and format it.
