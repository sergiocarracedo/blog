...
Básicamente nos obliga a indicar nuestras *intenciones* *para que el navegador se fíe de nosotros*. La forma más sencilla de implementarlo en PHP es mediante el envío de cabeceras
