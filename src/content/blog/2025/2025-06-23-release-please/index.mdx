...
heroImageMeta:
  author: ChatGPT
  prompt: >-
    Image of a staircase seen from the side, going up from left to right, with a
    point showing a trajectory using a dotted line of jumps to climb the steps.
    It should be colorful, with a gradient from pastel green to blue, and
    photorealistic. The format must be 16:9, and the ball should emit some
    light.
tags:
  - ci-cd
  - release
