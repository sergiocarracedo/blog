...
A design system is a collection of reusable components, guidelines, patterns, and best practices that help a company to **build consistent** and **efficient user** interfaces. It provides the building blocks to create a cohesive user experience across your product or products and platforms. Multiple disciplines are involved: Design, Frontend engineering, Product management, and more.
...
**- Is it always necessary to have a design system?** I think so (at least in most cases), a design system helps to create consistent user experiences, to speed up the development process, and to make the base maintainable.
...
But if you have a complex product or a large team, then it is worth having a dedicated design system team to ensure that the design system is well-maintained, up-to-date, and aligned with the product's goals.
...
**The main goal of a design system team is to free up product teams from non-product-related tasks. Letting them focus on building product-related features and solving user problems.**
...
In any case, we can split that goal into smaller goals:
