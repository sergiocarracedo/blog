    ...
    steps:
      ...
      - name: Analyze TypeScript Exports
        ...
        with:
          ...
          compare: false # Set to true to compare agains base
          list-changes: false # Set to true list the changes (needs compare true)
