...
> For the examples I ran the tool against [Factorial's f0 design system](https://github.com/factorialco/f0), which is an open source project big enought to get nice and realistic results.
