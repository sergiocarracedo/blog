...
For example, Open AI just released (at the moment of writing this post) [Operator](https://operator.chatgpt.com/) which is a "_agent that can use its browser to perform tasks for you._". [LangChain](https://www.langchain.com/) provides agents and an API to create new ones.
