...
Nowadays, using skill files (SKILL.md) is a common way to provide context and knowledge (or new capabilities and expertise, as the official skills specification [website](https://agentskills.io/home) describes) to an LLM or agent.
